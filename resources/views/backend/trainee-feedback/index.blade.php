                ...
                <div class="card">
                    <div class="card-header text-primary custom-bg-gradient-info">
                        ...
                        <div class="card-tools">
                            <a href="{{route('admin.batches.trainees', [$trainee->batch_id])}}"
                    ...
                    <div class="card-body">
                        <form
                            action="{{$edit ? '': route('admin.trainer-feedbacks.store')}}"
                            method="POST" class="row feedback-form">
                            @csrf
                            <input type="hidden" name="batch_id" value="{{$trainee->batch_id}}">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" placeholder="{{__('admin.trainee_batches.feedback')}}"
                                              name="feedback" id=""  rows="3" {{ $edit ? 'readonly' : '' }}>{{ $edit ? $traineeFeedback->feedback:old('feedback') }}</textarea>
                                </div>
                            </div>
