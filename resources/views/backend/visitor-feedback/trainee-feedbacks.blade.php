...
@section('title')
    {{ __('admin.trainee_batches.trainee_feedbacks')  }}
@endsection
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header text-primary custom-bg-gradient-info">
                        <h3 class="card-title font-weight-bold">{{ __('admin.trainee_batches.trainee_feedbacks')  }}</h3>
    ...
    <script>
        $(function () {
            let params = serverSideDatatableFactory({
                url: '{{route('admin.trainee-feedbacks.datatable')}}',
                //order: [[0, "desc"]],
                columns: [
                    {
                        title: "SL#",
